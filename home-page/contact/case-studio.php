        ...
        <div class="row">
            <div class="col-md-6 animate fadeInUp" data-wow-delay="0.4s">
                <div class="contact-left">
                    ...
                    <div class="contact-info margin-top-50 animate fadeInUp" data-wow-delay="0.4s">
                        <h6 class="margin-top-30 margin-bottom-20 font-bold">NEW DELHI</h6>
                        <ul class="row font-roboto">
                            <li class="col-md-4"> 35 Elm St<br>
                                Rugaong, 12569<br>
                                Dublin </li>
                        ...
                        <div class="contact-right padding-top-30 ">
                            ...
                            <form role="form" id="contact_form" class="contact-form" method="post" onSubmit="return false">
                                <ul class="row">
                                    ...
                                    <li class="col-sm-12">
                                        <label>
                                            <textarea class="form-control" name="message" id="message" rows="5" placeholder="Actually I was pretty happy when I saw that you had to listen to a song to travel to moon but I was pretty shaken when they asked me to buy the song for 3M.. I mean that was ok.."></textarea>
                                        </label>
                                    </li>
                                    <li class="col-sm-12">
                                        <button type="submit" value="submit" class="btn" id="btn_submit" onClick="proceed();">Send
                                            Mesage</button>
                                    </li>
                                </ul>
                            </form>
