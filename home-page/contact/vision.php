<section class="intro section-150px">
    <div class="container">
        <div class="about-us animate fadeInUp" data-wow-delay="0.4s">
            <h3 class="padding-b-20"><strong><u>OUR VISION</u></strong></h3>
        ...
        <div class="about-us animate fadeInUp" data-wow-delay="0.4s">
            ...
            <p><strong>We honous your privacy</strong></p>
            <ul>
                ...
                <li>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text,
                    and a search for
                    'lorem ipsum' will uncover many web sites still in their infancy.</li>
                <li>Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected
                    humour and the
                    like).
                </li>
            </ul>
