<section class="services">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6 no-padding animate fadeInLeft" data-wow-delay="0.4s"> <img class="img-responsive" src=<?php echo get_template_directory_uri() . "/assets/images/services-img-2.jpg" ?> alt=""> </div>
