<section class="services">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 no-padding animate fadeInRight" data-wow-delay="0.4s"> <img class="img-responsive" <?php echo get_template_directory_uri() . "/assets/images/services-img-1.jpg" ?> alt=""> </div>
        </div>
        <div class="row">
            <div class="col-md-6 no-padding animate fadeInLeft" data-wow-delay="0.4s"> <img class="img-responsive" <?php echo get_template_directory_uri() . "/assets/images/services-img-2.jpg" ?> alt=""> </div>
                    ...
                    <ul class="row">
                        <li class="col-sm-6 margin-bottom-50 animate fadeInUp" data-wow-delay="0.6s">
                            ...
                            <p>We are a team of eight sharing our expertise
                                ...
                                Packaging and pretty Photography
                            </p>
                        </li>
