...
<section class="container margin-b-40" style="padding: 0px;">
    <div class="tp-banner-container">
        <div class="tp-banner">
            <ul>
                <!-- Slider 1 -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src=<?php echo get_template_directory_uri() . "/assets/images/service_4/1.jpg" ?> alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                </li>

                <!-- Slider 2 -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src=<?php echo get_template_directory_uri() . "/assets/images/service_4/1-1.jpg" ?> alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                </li>

                <!-- Slider 3 -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src=<?php echo get_template_directory_uri() . "/assets/images/service_4/2.jpg" ?> alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                </li>
                ...
                <!-- Slider 3 -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src=<?php echo get_template_directory_uri() . "/assets/images/service_4/4.jpg" ?> alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                </li>
                ...
                <!-- Slider 3 -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700"> <img src=<?php echo get_template_directory_uri() . "/assets/images/service_4/6.jpg" ?> alt="" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                </li>
