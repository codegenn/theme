            ...
            <div class="row">
                ...
                <div class="col-md-6 animate fadeInUp" data-wow-delay="0.4s">
                    <div class="d-flex">
                        ...
                        <div class="d-flex flex-column text-left">
                            <h4><strong>Quick delivery</strong></h4>
                            <p class="bd width-40 margin-t-10 margin-b-20"></p>
                            <span>We provide the best services within a quick turnaround time (12-24 hours) </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 animate fadeInUp" data-wow-delay="0.4s">
                    <div class="d-flex">
                        ...
                        <div class="d-flex flex-column text-left">
                            <h4><strong>Reasonable price</strong></h4>
                            <p class="bd width-40 margin-t-10 margin-b-20"></p>
                            <span>We assure to offer the best-in-industry head shoot editing services at cost-effective rates and customize those based on the client's requirement</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 animate fadeInUp" data-wow-delay="0.4s">
                    <div class="d-flex">
                        ...
                        <div class="d-flex flex-column text-left">
                            <h4><strong>Top-world quality</strong></h4>
                            <p class="bd width-40 margin-t-10 margin-b-20"></p>
                            <span>Our team of talented and highly trained editors promise to bring you the best quality for images</span>
                        </div>
                    </div>
                </div>
            </div>
